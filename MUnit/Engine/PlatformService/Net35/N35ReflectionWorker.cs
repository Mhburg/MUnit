...
namespace MUnit.Engine.Net35
{
    ...
    /// </summary>
    internal class N35ReflectionWorker : IReflectionWorker
    {
        /*********************************************************************************************************
        ...
        *********************************************************************************************************/
        ...
        /// <inheritdoc/>
        public virtual bool HasAttributeIsOrDerivedFrom(MemberInfo memberInfo, Type baseAttributeType, bool inherit)
        {
            ThrowUtilities.NullArgument(memberInfo, nameof(memberInfo));
            ThrowUtilities.NullArgument(baseAttributeType, nameof(baseAttributeType));
            ...
            return GetAttributes(memberInfo, inherit)
                        .Keys
                        .Any(t => t.IsSubclassOf(baseAttributeType) || t == baseAttributeType);
        }
        ...
        {
            return GetAttributes(memberInfo, inherit)
                .Where(pair => pair.Key.IsSubclassOf(attributeBaseType))
        ...
        /// <inheritdoc/>
        public virtual bool TryGetAttributeAssignableTo(MemberInfo memberInfo, Type assignToType, bool inherit, out Attribute attribute)
        {
            attribute = this.GetAttributeAssignableTo(memberInfo, assignToType, inherit);
            if (attribute == null)
            {
                return false;
            }
        ...
        /// <inheritdoc/>
        public virtual IEnumerable<MethodInfo> GetDeclaredMethods(Type type)
        {
            return type.GetMethods(BindingFlags.Instance | BindingFlags.Static | BindingFlags.Public | BindingFlags.DeclaredOnly).AsEnumerable();
        }
        ...
        /// <inheritdoc/>
        public string GetExecAssemblyLocation()
        {
