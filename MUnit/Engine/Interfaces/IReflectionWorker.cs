// <copyright file="IReflectionWorker.cs" company="Zizhen Li">
...
namespace MUnit.Engine
{
    ...
    public interface IReflectionWorker
    {
        ...
        /// <summary>
        /// Returns and attribute of <paramref name="type"/>. Returns Null if no attribute of <paramref name="type"/> is defined.
        /// </summary>
        ...
        /// <summary>
        /// Get instances of attribute of <paramref name="type"/> on a member.
        /// </summary>
        ...
        /// <summary>
        /// Check if <paramref name="memberInfo"/> has attribute derived from <paramref name="baseAttributeType"/>.
        /// </summary>
        ...
        /// <returns> Returns true when <paramref name="memberInfo"/> has attribute derived from <paramref name="baseAttributeType"/>. </returns>
        bool HasAttributeDerivedFrom(MemberInfo memberInfo, Type baseAttributeType, bool inherit);

        /// <summary>
        /// Check if <paramref name="memberInfo"/> is or has attribute derived from <paramref name="baseAttributeType"/>.
        /// </summary>
        /// <param name="memberInfo">The member info.</param>
        /// <param name="baseAttributeType">The base attribute type.</param>
        /// <param name="inherit">Should look at inheritance tree.</param>
        /// <returns> Returns true when <paramref name="memberInfo"/> is or has attribute derived from <paramref name="baseAttributeType"/>. </returns>
        bool HasAttributeIsOrDerivedFrom(MemberInfo memberInfo, Type baseAttributeType, bool inherit);
        ...
        /// <param name="assignToType"> Type that attribute can be assigned to. </param>
        /// <param name="inherit">Look throug bases of <paramref name="memberInfo"/> or not.</param>
        /// <param name="attribute"> Attribute to be returned if found. </param>
        /// <returns> Attribute that can assign to <paramref name="assignToType"/>. </returns>
        bool TryGetAttributeAssignableTo(MemberInfo memberInfo, Type assignToType, bool inherit, out Attribute attribute);
        ...
        /// <summary>
        /// Gets absolute path to the executing assembly.
        /// </summary>
        /// <returns> absolute path to the executing assembly. </returns>
        string GetExecAssemblyLocation();
    }
}